...
//        2D array → rectangular (same columns in every row)
//        Jagged array → irregular (different columns per row)
...
class Program
{
    static void Main()
    {
        ...
        // Step 2: Initialize each inner array with DIFFERENT sizes
        jaggedArray[0] = new int[3]; // Row 0 → 3 elements
        jaggedArray[1] = new int[2]; // Row 1 → 2 elements
        jaggedArray[2] = new int[4]; // Row 2 → 4 elements
